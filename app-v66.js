/* PROJECT 11122 v6.6 · CSAT EDITION */
'use strict';
...
function renderPlannerQuickPanel(){
 ...
 <div class="planner-sleep-box">
   ...
   <div class="planner-sleep-row"><div class="planner-sleep-icon">☼︎</div><div class="planner-sleep-value">${wake||'–'}</div></div>
...
function init(){
 ...
 if('serviceWorker'in navigator)navigator.serviceWorker.register('./sw-v66.js?v=660').catch(()=>{});
}
